...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'ID gerado automaticamente pelo banco' }),
    __metadata("design:type", Number)
], CategoryResponseDto.prototype, "id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Tecnologia', description: 'Nome da categoria cadastrada' }),
